...
const /*MessageType*/(
LICENSE_REQUEST MessageType = 0x01
...
const (
ERR_INVALID_SERVER_CERTIFICATE ErrorCode = 0x00000001
 ...
 * @see http://msdn.microsoft.com/en-us/library/cc240482.aspx
*/
type StateTransition uint32
const /*StateTransition*/ (
ST_TOTAL_ABORT StateTransition = 0x00000001
...
const (
BB_ANY_BLOB BinaryBlobType = 0x0000
BB_DATA_BLOB = 0x0001
...
type Preambule uint8
const (
PREAMBLE_VERSION_2_0 Preambule = 0x2
...
type ServerLicenseRequest struct {
	...
	keyExchangeList LicenseBinaryBlob
	serverCertificate LicenseBinaryBlob
	scopeList ScopeList
}
/*
 ...
 * @returns {type.Component}
*/
type SlientNewLicenseRequest struct {
	core.Component
	__TYPE__  MessageType
	...
	platformId uint32
	clientRandom []byte
	encryptedPreMasterSecret LicenseBinaryBlob
	ClientUserName LicenseBinaryBlob
	ClientMachineName LicenseBinaryBlob
}
/*
